...
<body>
    ...
    <form class="form" method="post">
        <div class="container">
            ...
            <button formaction="consultar.php" id="botao" class="btn btn-primary" type="submit">Consultar</button>

            <?php
            if (!empty($_POST)) {
                echo "<button formaction=\"excluirAgendamento.php\" id=\"botao\" class=\"btn btn-primary\" type=\"submit\">Excluir viagem</button>";
            }
            ?>
            ...
            <div id="resultadoConsulta">
                ...
                <?php
                //incluir codigo para exibir, testar o post se é vazio se nao for exibir uma lista com resultados.

                if (!empty($_POST)) {
                    while ($row = $resultado->fetch_assoc()) {
                        echo "ID: " . $row["idAgendamento"] . " - Endereço de Embarque: " . $row["enderecoEmbarque"] . "<br>";
